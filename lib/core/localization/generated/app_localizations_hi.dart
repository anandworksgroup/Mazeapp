...
class AppLocalizationsHi extends AppLocalizations {
  ...
  String get privacyBody =>
      'मेज़ एडवेंचर में न कोई खाता है, न कोई सर्वर। आपकी प्रगति, आँकड़े और सेटिंग्स इसी डिवाइस पर रहते हैं और कहीं नहीं भेजे जाते, और गेम बिना इंटरनेट के चलता है। ऐप इंटरनेट का उपयोग सिर्फ़ दो चीज़ों के लिए करता है: स्क्रीन के नीचे और भूलभुलैया के बीच दिखने वाले विज्ञापन, जो Google AdMob से आते हैं और सिर्फ़ बच्चों के लिए उपयुक्त सेट किए गए हैं; और वैकल्पिक फ़ुल अनलॉक खरीद, जो कोई बड़ा App Store या Google Play से करता है। फ़ुल अनलॉक विज्ञापन भी हटा देता है।';
  ...
  String get fullUnlockBody =>
      'सभी साथी, दुनिया और आकार अभी खोलें और विज्ञापन हटाएँ। एक बार भुगतान, कोई सदस्यता नहीं। सब कुछ खेलकर मुफ़्त में भी खुल सकता है।';
